...
# exp_name="0712_0118_step90_mean4_dev_normal_challenge_temp06_resp61k_noturnlimit"
exp_name="0724_0118_step90_mean4_dev_normal_challenge_temp06_resp61k_100turn"
...
# Retained exactly from the archived command: the SGLang rollout override uses
# factor 4.0 while the actor/model override below uses factor 2.0. Do not treat
# this command as a single resolved rope-scaling configuration.
...
ray job submit --address="${RAY_ADDRESS}" \
    ...
    +actor_rollout_ref.model.override_config.rope_scaling.rope_theta=1000000 \
    ...
    +actor_rollout_ref.rollout.engine_kwargs.sglang.context_length=${context_length} \

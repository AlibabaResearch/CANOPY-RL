...
agent_config_path="recipe/swe/config/swe_agent_xml_config.yaml"
CONFIG_PATH="config"

output_base="${OUTPUT_ROOT}"
data_base="${DATA_ROOT}"
rebench_base="${data_base}"
vbench_base="${data_base}"

train_fname="rebench_v1_maxlen4k_group8"
train_files="[${rebench_base}/${train_fname}.parquet]"
...
exp_name="0528_qwen35_9b_rebenchv1_bs${bs}_ppomicrobs${ppo_micro_batch_size_per_gpu}_${max_assistant_turns}turns_resp${respk}k_tp${actor_tp}_pp${actor_pp}_cp${actor_cp}_rollouttp${rollout_tp}_${nnodes}nodes"
...
# env_resource_tokens=2
# env_cpu_limit="4"
# env_mem_limit="8g"
# ray_env_actor_num_cpus=0.01

# env_resource_tokens=4.0
# env_cpu_limit="2.4"
# env_mem_limit="6g"
# ray_env_actor_num_cpus=0.08

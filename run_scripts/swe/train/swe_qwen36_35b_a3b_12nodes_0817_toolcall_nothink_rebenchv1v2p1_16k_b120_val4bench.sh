...
# This command exercises Megatron R2 router replay and multi-node SGLang port
# coordination. Run the compatibility checks and a one-batch cluster smoke test
# documented in docs/VERL_COMPATIBILITY.md before a full training job.
...
exp_name="0817_swe_qwen36_35b_a3b_rebenchv1v2p1_16k_b120_n16_cpu2_envtok10_ep3_eval50_proeval${swe_bench_pro_eval_timeout}_val4bench_prompt${promptk}k_resp${respk}k_turns${max_assistant_turns}_interaction3600_repeat3"

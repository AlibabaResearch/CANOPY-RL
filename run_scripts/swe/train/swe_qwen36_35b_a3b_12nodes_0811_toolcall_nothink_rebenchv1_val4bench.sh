...
# This latest Qwen3.6 configuration requires core fixes that are intentionally
# not copied from the still-changing development checkout into bundled verl/.
...
swe_rebench_v1_train_file="${data_base}/rebench_v1_maxlen6k_group12.parquet"

train_files="[${swe_rebench_v1_train_file}]"

swe_rebench_val_file="${data_base}/rebench_leaderboard_maxlen6k_group12.parquet"
swe_bench_verified_val_file="${data_base}/swe_bench_verified_maxlen6k_group12.parquet"
swe_bench_multilingual_val_file="${data_base}/swe_bench_multilingual_maxlen6k_group12.parquet"

val_files="[${swe_rebench_val_file},${swe_bench_verified_val_file},${swe_bench_multilingual_val_file}]"
...
exp_name="08112_swe_qwen36_35b_a3b_noskip_lxcfs_rebench6k_native_call_prompt${promptk}k_resp${respk}k_turns${max_assistant_turns}_interaction3600_repeat3"
...
ray job submit --address="${RAY_ADDRESS}" \
    ...
    actor_rollout_ref.swe_custom_config.eval_timeout=500 \
    actor_rollout_ref.swe_custom_config.max_env_start_sleep_seconds=60 \
    ...
    actor_rollout_ref.swe_custom_config.env_resource_tokens=2 \
    ...
    actor_rollout_ref.swe_custom_config.env_mem_limit=6g \
    actor_rollout_ref.swe_custom_config.ray_env_actor_num_cpus=0.01 \

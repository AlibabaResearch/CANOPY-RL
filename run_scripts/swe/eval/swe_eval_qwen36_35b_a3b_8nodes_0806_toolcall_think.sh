...
agent_config_path="recipe/swe/config/swe_agent_qwen3_native_toolcall_think.yaml"
...
# 64K / 200 turns（默认）。如需还原 36K / 80 turns，注释下面三行，打开再下面的三行。
respk=64
max_assistant_turns=200
exp_name="swe_eval_0806_qwen36_35b_a3b_native_toolcall_think_resp64_turn200_n4_msall_nodes8_full_think64_precise_v1"

# 36K / 80 turns
# respk=36
# max_assistant_turns=80
# exp_name="swe_eval_0806_qwen36_35b_a3b_native_toolcall_think_resp36_turn80_n4_msall_nodes8_full_think36_precise_v1"
...
ray job submit --address="${RAY_ADDRESS}" \
    ...
    actor_rollout_ref.swe_custom_config.enable_thinking=${enable_thinking} \
    ...
    actor_rollout_ref.swe_custom_config.map_testbed_to_tmpfs=${map_testbed_to_tmpfs} \

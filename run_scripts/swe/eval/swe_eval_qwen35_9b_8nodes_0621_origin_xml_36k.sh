...
exp_name="0621_qwen35_9b_eval_swev_${max_assistant_turns}turns_resp${respk}k_origin_xml_think_valn${valn}_greedy"
...
ray job submit --address="${RAY_ADDRESS}" \
    ...
    actor_rollout_ref.swe_custom_config.enable_thinking=True \
    ...
    actor_rollout_ref.swe_custom_config.drop_action_parse_failed_assistant_message=True \
